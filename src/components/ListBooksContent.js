    ...
    return (
      <div className="list-books">
        ...
        <div className="list-books-content">
          <Shelf shelfTitle="Currently Reading"  books={this.state.currentlyReadingShelf}/>
          <Shelf shelfTitle="Want to Read" books={this.state.wantToReadShelf}/>
          <Shelf shelfTitle="Read" books={this.state.readShelf}/>
